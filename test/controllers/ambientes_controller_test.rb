...
class AmbientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ambiente" do
    assert_difference('Ambiente.count') do
      post ambientes_url, params: { ambiente: { descricao: @ambiente.descricao, nome: @ambiente.nome } }
    end
  ...
  test "should update ambiente" do
    patch ambiente_url(@ambiente), params: { ambiente: { descricao: @ambiente.descricao, nome: @ambiente.nome } }
